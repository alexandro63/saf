...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $data = [
            // ==== ADMINISTRACIÓN ====
            'administracion' => [
                'administracion.view',    // acceder al dashboard o sección principal
            ],
            ...
            // ==== ALUMNOS INSCRITOS (listado) ====
            'alumno_inscrito' => [
                'alumno.inscrito.index',
            ],
