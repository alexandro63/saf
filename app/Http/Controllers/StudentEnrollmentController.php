        ...
        if (request()->ajax()) {
            ...
            return DataTables::of($student_enrollments)
                ->addColumn('action', function ($row) {
                    ...
                    $buttons = '
                    <button data-href="' . $editUrl . '" class="btn btn-icon btn-round btn-primary btn-sm edit_student_enrollment" title="Editar">
                        <i class="icon-pencil"></i>
                    </button>
                    &nbsp;';

                    $buttons .= '
                    <button data-href="' . $showUrl . '" class="btn btn-icon btn-round btn-secondary btn-sm btn-modal" title="Asignación de materia"
                    ...
                    $buttons .= '
                    <button data-href="' . $deleteUrl . '" class="btn btn-icon btn-round btn-danger btn-sm delete_student_enrollment" title="Eliminar">
