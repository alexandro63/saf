...
class TeacherController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            $teachers = Teacher::select(['doc_id', 'doc_per_id', 'doc_estado'])->orderBy('doc_id', 'desc')->with('people')
                ->get();
            return DataTables::of($teachers)
                ->addColumn('action', function ($row) {
                    ...
                    $buttons = '
                    <button data-href="' . $editUrl . '" class="btn btn-icon btn-round btn-primary edit_teacher">
                    ...
                    $buttons .= '
                    <button data-href="' . $deleteUrl . '" class="btn btn-icon btn-round btn-danger delete_teacher">
                ...
                ->addColumn('apellidopat', function ($row) {
                    return $row->people->per_apellidopat;
                })
                ->addColumn('apellidomat', function ($row) {
                    return $row->people->per_apellidomat;
                })
                ->addColumn('nombres', function ($row) {
                    return $row->people->per_nombres;
                })
    ...
    {
        $grade_academic = Teacher::getGradeAcademic();
