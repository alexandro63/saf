<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form action="{{ route('administrative.store') }}" method="POST" id="add_teacher">
                @csrf
                ...
                <div class="step" data-step="1">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-group-default required">
                                <label for="doc_pago">Salario</label>
                                <input type="text" class="form-control input-number"
                                    placeholder="Ingrese Pago x Hora" name="doc_pago" id="doc_pago">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="step" data-step="2" style="display: none;">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-group-default required">
                                <label form="doc_fec_ing">Fecha de Inicio</label>
                                <input name="doc_fec_ing" type="date" class="form-control" id="doc_fec_ing">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-group-default required">
                                <label form="doc_fec_ing">Fecha Final</label>
                                <input name="doc_fec_ing" type="date" class="form-control" id="doc_fec_ing">
                            </div>
                        </div>
