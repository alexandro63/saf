<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form action="{{ route('academic_planning.update', $academic_planning->plan_id) }}" method="POST"
                id="edit_academic_planning">
                @csrf
                @method('PUT')
                ...
                <div class="step" data-step="1">
                    <div class="alert alert-warning text-center font-weight-bold py-1">
                        Datos Materia Docente Aula
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group form-group-default required">
                                ...
                                <select class="form-control" name="plan_mat_id" id="plan_mat_id">
                                    @if (!empty($academic_planning))
                                        <option value="{{ $academic_planning->plan_mat_id }}" selected>
                                            {{ $academic_planning->subject->mat_nombre }}
                                        </option>
                                    @endif
                                </select>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-group-default required">
                                ...
                                <select class="form-control" name="plan_amb_id" id="plan_amb_id">
                                    @if (!empty($academic_planning->plan_amb_id))
                                        <option value="{{ $academic_planning->plan_amb_id }}" selected>
                                            {{ $academic_planning->classroom->amb_nombre }}
                                        </option>
                                    @endif
                                </select>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-group-default required">
                                ...
                                <input name="plan_fec_ini" type="date" class="form-control" id="plan_fec_ini"
                                    value="{{ $academic_planning->plan_fec_ini }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-group-default required">
                                ...
                                <input name="plan_fec_fin" type="date" class="form-control" id="plan_fec_fin"
                                    value="{{ $academic_planning->plan_fec_fin }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-group-default required">
                                ...
                                <input name="plan_hor_ini" type="time" class="form-control" id="plan_hor_ini"
                                    value="{{ $academic_planning->plan_hor_ini }}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="step" data-step="3" style="display: none;">
                    ...
                    <div class="row">
                        ...
                        <label class="font-weight-bold text-danger m-1">Días (*)</label>
                                ...
                                <tbody>
                                    @foreach ($schedules as $key => $schedule)
                                        <tr>
                                            ...
                                            <td>{{ $schedule['hourEnd'] }}</td>
                                            <td><button class="btn btn-xs btn-danger btnDeleted" title="Eliminar"> <i
