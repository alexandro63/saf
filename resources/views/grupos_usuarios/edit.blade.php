<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <p class="small">
                Llena todos los campos para actualizar el registro.
            </p>

            <form action="{{ route('group_users.update', $group_user->gru_id) }}" method="POST" id="edit_group_user">
                @csrf
                @method('PUT')
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group form-group-default">
                            ...
                            <input type="text" class="form-control" placeholder="Ingrese descripción" name="gru_obs"
                                value="{{ $group_user->gru_obs }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" type="checkbox" {{ $group_user->gru_estado ? 'checked' : '' }}
                                    name="gru_estado">
